...
export const aplicacionFormConfig = [
  ...
  { key: 'idest', label: 'Estado', type: 'select', required: true, options: [] }, // Nuevo
  ...
  { key: 'recomendacionapl', label: 'Recomendación', type: 'textarea', required: false, placeholder: 'Instrucciones...' },
];

export const aplicacionesFiltersConfig = [
  { key: 'search', label: 'Buscar fertilizante', type: 'text', placeholder: 'Buscar...', icon: <BiSearch /> },
  { key: 'forma', label: 'Forma', type: 'select', options: [] },
  { key: 'etapa', label: 'Etapa', type: 'select', options: [] },
  { key: 'estado', label: 'Estado', type: 'select', options: [] }, // Nuevo
];
...
export const aplicacionesColumns = [
  ...
  { header: 'Estado', accessor: 'estadoNombre' }, // Nuevo
];